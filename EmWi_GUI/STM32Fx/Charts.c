...
void ChartsCoord__Init( ChartsCoord _this, XObject aLink, unsigned long aArg )
{
...
void ChartsGraph__Init( ChartsGraph _this, XObject aLink, unsigned long aArg )
{
  /* At first initialize the super class ... */
...
void ChartsCoordList__Init( ChartsCoordList _this, XObject aLink, unsigned long aArg )
{
  /* At first initialize the super class ... */
  XObject__Init( &_this->_Super, aLink, aArg );
