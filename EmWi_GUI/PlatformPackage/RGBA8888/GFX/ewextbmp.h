...
#define EW_BITMAP_PIXEL( aName, aLangId )                                      \
  ...
  extern const unsigned long _cp_##aName##aLangId[];                           \
  ...
  {                                                                            \
    ...
    #aName                                                                     \
                                                                               ...
                                                                               \
  const unsigned long _cp_##aName##aLangId[] =                                 \
  {
...
#define EW_BITMAP_PIXEL_U32( aName, aLangId )                                  \
  ...
  extern const unsigned long _p1_##aName##aLangId[];                           \
  static const XBmpRes _##aName##aLangId =                                     \
  {                                                                            \
    EW_MAGIC_NO_BITMAP,                                                        \
    _ff_##aName##aLangId,                                                      \
    ...
    #aName                                                                     \
                                                                               ...
                                                                               \
  const unsigned long _p1_##aName##aLangId[] =                                 \
  {
