...
#if ( EW_MAX_GLYPH_SURFACE_WIDTH < 128 )
  #error "The glyph surface width is less than 128."
#endif
...
#if ( EW_MAX_GLYPH_SURFACE_HEIGHT < 128 )
  #error "The glyph surface height is less than 128."
#endif
